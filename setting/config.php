	...
	
{
	...
	///////////////////// Parents /////////////////
	public function parent_login_check($pr_username,$pr_password)
	{ 
		$pr_login_check = "select  * from parents_info where pr_username = '$pr_username' and pr_pass='$pr_password'";
		$pr_login_run = $this->connectdb->query($pr_login_check);
		$pr_login_num = $pr_login_run->num_rows;
		return $pr_login_num;
	}
	public function parent_info_select($pr_username)
	{
		$parent_info_sel = "select * from st_info FULL JOIN parents_info where pr_username='$pr_username'";
	...
	//////////////////////////////////Teacher Info ////////////////////////////////
	public function teacher_login_check($t_username,$t_pass)
	{ 
		$t_login_check = "select  * from teacher_info where t_username = '$t_username' and t_pass='$t_pass'";
	...
	public function teacher_password_change($t_password_update,$t_username)
	{
		$teacher_password_update = "update teacher_info set t_pass='$t_password_update' where t_username='$t_username'";
		$teacher_password_update_run = $this->connectdb->query($teacher_password_update);
		return $teacher_password_update_run;
	}

	public function parent_password_change($pr_password_update,$pr_username)
	{
		$pr_password_update = "update parents_info set pr_pass='$pr_password_update' where pr_username='$pr_username'";
		$pr_password_update_run = $this->connectdb->query($pr_password_update);
		return $pr_password_update_run;
	}
